...
{
    public record GetAllActivesForAdminQuery:IRequest<ErrorOr<List<OrderAdminQueryModel>>>;
    public class GetAllActivesForAdminQueryHandler : IRequestHandler<GetAllActivesForAdminQuery, ErrorOr<List<OrderAdminQueryModel>>>
    {
        private readonly IOrderDiscountRepository _orderDiscountRepository;

        public GetAllActivesForAdminQueryHandler(IOrderDiscountRepository orderDiscountRepository)
        {
            _orderDiscountRepository = orderDiscountRepository;
        }

        public async Task<ErrorOr<List<OrderAdminQueryModel>>> Handle(GetAllActivesForAdminQuery request, CancellationToken cancellationToken)
        {
