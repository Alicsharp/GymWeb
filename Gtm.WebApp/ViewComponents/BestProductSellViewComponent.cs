...
namespace Gtm.WebApp.ViewComponents
{
    public class BestProductSellViewComponent : ViewComponent
    {
        ...
        public BestProductSellViewComponent(IMediator mediator, IAuthService authService)
        {
            _mediator = mediator;
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var modelResult = await _mediator.Send(new GetBestSellingProductsForIndexQuery());
            ...
            foreach (var item in model)
            {
                ...
                else
                {
                  ...
                  var s=await _mediator.Send(new IsUserHaveProductWishListCommand(userId, item.Id));
                    item.isWishList = s.Value;
                }
            }
