...
namespace Gtm.Domain.DiscountsDomain.OrderDiscount
{
    public class OrderDiscount : BaseEntityCreate<int>
    {
        public OrderDiscount(int percent, string title, string code, int count,OrderDiscountType type, DateTime startDate, DateTime endDate, int shopId)
        {
            Percent = percent;
            Title = title;
            Code = code;
