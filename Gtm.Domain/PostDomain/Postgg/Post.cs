...
namespace Gtm.Domain.PostDomain.Postgg
{
    //مبلغ افزوده بر اساس کلیو گرم است
    public class Post : BaseEntityCreateActive<int>
    {
        public string Title { get; private set; } //عنوان پست
        public string Status { get; private set; } //وضعیت پست
        public string? Description { get; private set; } //توضیحات اختیاری
        public int TehranPricePlus { get; private set; }//مبلغ افزوده به حمل به تهران
        public int StateCenterPricePlus { get; private set; } // مبلغ افزوده به حمل به استان مرکزی
        public int CityPricePlus { get; private set; } // مبلغ افزوده به درون شهری
        public int InsideStatePricePlus { get; private set; } // مبلغ افزوده به  حمل درون استانی
        public int StateClosePricePlus { get; private set; } // مبلغ افزوده به استان های همجوار
        public int StateNonClosePricePlus { get; private set; } // مبلغ افروده به استان های هم غیر همجوار
        public bool InsideCity { get; private set; } // ایا خدمات درون شهری است 
        public bool OutSideCity { get; private set; } // ایا خدمات برون شهری است
        public List<PostPrice> PostPrices { get; set; } // مبلغ بر اساس وزن
        public Post(string title, string status, int tehranPricePlus,int stateCenterPricePlus, int cityPricePlus, int insideStatePricePlus,int stateClosePricePlus, int stateNonClosePricePlus, string description)
        {
